...
static const char *errors_mac[ERR_COUNT] = {
    "Undefined error: 0",
...
static const char *errors_linux[ERR_COUNT] = {
    "Success",
    "Operation not permitted",
    "No such file or directory",
    "No such process",
...
void handle_value(flags flags, char *buff, va_list v_l);
void parse_int(flags flags, char *buff, va_list v_l);
